        ...
        for fixture_set,fixture,path in selected:
            ...
            for variant in fixture["variants"]:
                payload={
                  ...
                  "instruction":"Return only a decision_record JSON object. Reconstruct target identity before causal weighting: keep speaker intent separate from corpus operations, remove each target name, enumerate the exact surviving measurements and constructions, require a recoverable generator for any identity shortcut, keep non-equivalent operationalizations separate, and treat unexplained heterogeneity as identity-breaking rather than construct protection. Extract actual data before narrative, separate every target relation, keep every explanation on one continuous physical chain, bind biological and behavioral claims through metabolically maintained state, mark unmeasured physical or metabolic segments unresolved rather than inventing them, and place final wording only in structured claims."
                }
